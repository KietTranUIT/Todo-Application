...
const (
	...
	SuccessInsertCategory   ErrorCode = "SUCCESS INSERT CATEGORY"
)
...
const (
	...
	DuplicateCategoryMsg     string = "duplicate category"
	...
	SuccessInsertCategoryMsg string = "success insert category"
)
